...
function VideoDetail() {
  ...
  const { snippet: { channelId, channelTitle, title }, statistics: { viewCount, likeCount } } = videoDetail
  ...
  return (
    <>
      <Box minHeight='95vh'>
        ...
        <Box px={{md: 10, xs: 2}} py={{ md: 5, xs: 5 }} justifyContent="center" alignItems="center" >
          <Vedios Vedios={suggestedVideos} />
        </Box>
      </Box>
    </>
  )
